...
const CONTEXT_PROMPT = `You are helping Ariel, a 42-year-old Senior Data Engineer at PayScale Inc (fintech/payments) prepare for a Microsoft Data Engineer technical interview. 

ARIEL'S BACKGROUND:
- 4 years experience at PayScale Inc/Acme Corp (ETL pipelines, Snowflake, DBT, Airflow, Python/SQL)
- Currently taking Google/Reichman AI & Deep Learning course
- Has IDC MBA background, worked at Taboola, eBay before PayScale Inc
...
- Reference your PayScale Inc experience when relevant
