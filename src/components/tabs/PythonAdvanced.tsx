...
const PythonAdvanced = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 pb-36 md:pb-8">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold mb-2">Python Advanced</h1>
        <p className="text-gray-600 dark:text-gray-400">
          Advanced Python concepts and optimization techniques for data engineering interviews.
          Focus on performance, memory management, and advanced algorithms.
        </p>
      </div>
