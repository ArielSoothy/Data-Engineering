...
const SQLAdvanced = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 pb-36 md:pb-8">
      <div className="mb-6">
        <h1 className="text-2xl font-bold mb-2">SQL Advanced</h1>
        <p className="text-gray-600 dark:text-gray-400">
          Advanced SQL concepts and complex scenarios for data engineering interviews.
          Master sophisticated querying techniques and optimizations.
        </p>
      </div>
